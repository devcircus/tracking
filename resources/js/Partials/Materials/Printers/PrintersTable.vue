            ...
            <div class="flex justify-between items-center">
                ...
                <dropdown class="mr-1" right="10" width="180">
                    ...
                    <div slot="dropdown" class="flex flex-col mt-2 shadow-lg bg-white rounded">
                        ...
                        <inertia-link v-if="$page.auth.user.can.createPrinters" class="flex px-3 py-2 text-gray-700 hover:bg-blue-500 hover:text-white group" :href="route('printers.create')">
