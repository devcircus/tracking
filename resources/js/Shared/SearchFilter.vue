    ...
    <div class="flex items-center">
        <div class="flex w-full bg-white shadow rounded">
            <dropdown class="px-4 md:px-6 rounded-l border-r hover:bg-gray-100 focus:border-white focus:z-10" right="10">
                <div slot="trigger" class="flex items-center pt-3">
                ...
                <div slot="dropdown" class="mt-2 px-4 py-6 ml-24 md:ml-12 w-screen shadow-lg bg-white rounded" :style="{ maxWidth: `${maxWidth}px` }">
                    <slot />
                </div>
            </dropdown>
